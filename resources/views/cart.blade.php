                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        @php 
                              ...
                              $shipping_fee=count((Array) Session::get('cart')) > 0 ? 10 : 0;
                        @endphp
                        ...
                        @endphp
                        <tr>
                            <td class="align-middle"><img src="{{asset('uploads')}}/{{$product['photo']}}" alt="" style="width: 50px;"> {{$product['name']}}</td>
                         ...
                         <tr><td colspan="4"> <h1> Cart is empty... </h1> </td></tr>
