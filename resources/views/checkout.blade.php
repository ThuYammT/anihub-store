...
<body>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="customer_name" type="text" placeholder="MG Mg">
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom">
                        ...
                        $order_items.="".$product['name']."/".$product['price']."/".$product['quantity']."#";
    ...
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" name="payment_type" id="paypal" value="KPay">
        <label class="custom-control-label" for="paypal">KPay</label>
    </div>
</div>
<div class="form-group">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" name="payment_type" id="directcheck" value="Wave Pay">
        <label class="custom-control-label" for="directcheck">Wave Pay</label>
    </div>
</div>
<div class="form-group mb-4">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" name="payment_type" id="banktransfer" value="Cash On Delivery">
